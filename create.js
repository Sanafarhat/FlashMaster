document.addEventListener("DOMContentLoaded", () => {
    ...
    const loadFlashcardsFromStorage = () => {
        try {
            ...
            numCardsInput.value = 5;
            frontColorInput.value = '#1f006b';
    ...
    saveFlashcardsBtn.addEventListener("click", () => {
        ...
        if (currentTopicId) {
            ...
            showMessage(`Topic "${topicName}" saved successfully in your "My Topics"!`);
        }
        
        localStorage.setItem('flashmaster_custom_topics', JSON.stringify(allTopics));
        
        // This is the key part to clear the flashcards and reset the form.
        topicNameInput.value = '';
        numCardsInput.value = 5;
        frontColorInput.value = '#1f006b';
        backColorInput.value = '#3b00a0';
        flashcardEditorContainer.innerHTML = ''; // This line clears the flashcards from the display.
        saveFlashcardsBtn.style.display = 'none'; // This hides the save button.
        currentTopicId = null; // Resets the state for creating a new topic.
    });
